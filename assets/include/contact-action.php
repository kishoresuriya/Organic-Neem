<?php
        ...
        if ( empty($name) OR !filter_var($email, FILTER_VALIDATE_EMAIL) OR empty($message)) {
                    ...
                    $msg = 'Please complete the form/captcha and try again.';
                    echo $msg;
                    exit;
        }
        ...
        //Content
        $mail->Subject = $sub;
        $mail->Body    = "Dear Team,  Please find the details filled by a website visitor in the contact form (Contact us page) of the website.
        <br><br><b>Name:  </b>".$name. " 
